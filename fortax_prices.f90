...
sys%inctax%pa = sys%inctax%pa * factor
            ...
            sys%inctax%maxTPA = sys%inctax%maxTPA * factor
...
sys%bencap%sinNoKids = sys%bencap%sinNoKids * factor
            ...
            sys%bencap%LondonSinNoKids = sys%bencap%LondonSinNoKids * factor
            sys%bencap%LondonSinKids = sys%bencap%LondonSinKids * factor
            sys%bencap%LondonCouNoKids = sys%bencap%LondonCouNoKids * factor
            sys%bencap%LondonCouKids = sys%bencap%LondonCouKids * factor
...
sys2%inctax%numbands = sys%inctax%numbands
        ...
        sys2%inctax%doTPA = sys%inctax%doTPA
        sys2%inctax%maxTPA = sys%inctax%maxTPA * factor
...
sys2%ctc%fam = sys%ctc%fam * factor
        ...
        sys2%ctc%maxKids = sys%ctc%maxKids
...
sys2%cctaxrefund%doCCTaxRefund = sys%cctaxrefund%doCCTaxRefund
        ...
        sys2%cctaxrefund%ReceiptProp = sys%cctaxrefund%ReceiptProp
        sys2%cctaxrefund%MinEarn = sys%cctaxrefund%MinEarn * factor
        sys2%cctaxrefund%MaxInc = sys%cctaxrefund%MaxInc * factor
sys2%incsup%doIncSup = sys%incsup%doIncSup
        ...
        sys2%incsup%MinAgeMain = sys%incsup%MinAgeMain
        sys2%incsup%MinAgeMainSin = sys%incsup%MinAgeMainSin
        ...
        sys2%incsup%MinAgeFSM = sys%incsup%MinAgeFSM
        sys2%incsup%MaxAgeUniversalFSM = sys%incsup%MaxAgeUniversalFSM
...
sys2%ctax%docounciltax = sys%ctax%docounciltax
        ...
        sys2%ctax%EnglandRatioA = sys%ctax%EnglandRatioA
        sys2%ctax%EnglandRatioB = sys%ctax%EnglandRatioB
        sys2%ctax%EnglandRatioC = sys%ctax%EnglandRatioC
        sys2%ctax%EnglandRatioE = sys%ctax%EnglandRatioE
        sys2%ctax%EnglandRatioF = sys%ctax%EnglandRatioF
        sys2%ctax%EnglandRatioG = sys%ctax%EnglandRatioG
        sys2%ctax%EnglandRatioH = sys%ctax%EnglandRatioH
        sys2%ctax%EnglandRatioI = sys%ctax%EnglandRatioI
        sys2%ctax%ScotlandRatioA = sys%ctax%ScotlandRatioA
        sys2%ctax%ScotlandRatioB = sys%ctax%ScotlandRatioB
        sys2%ctax%ScotlandRatioC = sys%ctax%ScotlandRatioC
        sys2%ctax%ScotlandRatioE = sys%ctax%ScotlandRatioE
        sys2%ctax%ScotlandRatioF = sys%ctax%ScotlandRatioF
        sys2%ctax%ScotlandRatioG = sys%ctax%ScotlandRatioG
        sys2%ctax%ScotlandRatioH = sys%ctax%ScotlandRatioH
        sys2%ctax%ScotlandRatioI = sys%ctax%ScotlandRatioI
        sys2%ctax%WalesRatioA = sys%ctax%WalesRatioA
        sys2%ctax%WalesRatioB = sys%ctax%WalesRatioB
        sys2%ctax%WalesRatioC = sys%ctax%WalesRatioC
        sys2%ctax%WalesRatioE = sys%ctax%WalesRatioE
        sys2%ctax%WalesRatioF = sys%ctax%WalesRatioF
        sys2%ctax%WalesRatioG = sys%ctax%WalesRatioG
        sys2%ctax%WalesRatioH = sys%ctax%WalesRatioH
        sys2%ctax%WalesRatioI = sys%ctax%WalesRatioI
sys2%rebatesys%RulesUnderFC = sys%rebatesys%RulesUnderFC
        ...
        sys2%rebatesys%MinAgeMain = sys%rebatesys%MinAgeMain
        sys2%rebatesys%MinAgeMainSin = sys%rebatesys%MinAgeMainSin
...
sys2%hben%doHBen = sys%hben%doHBen
        ...
        sys2%hben%numUnderOccBands = sys%hben%numUnderOccBands
        sys2%hben%underOccRates = sys%hben%underOccRates
        sys2%hben%doLHA = sys%hben%doLHA
        sys2%hben%LHASharedAccAge = sys%hben%LHASharedAccAge
        sys2%hben%numLHABands = sys%hben%numLHABands
        sys2%hben%LHARates = sys%hben%LHARates
...
sys2%uc%doUnivCred = sys%uc%doUnivCred
        ...
        sys2%uc%MaxKids = sys%uc%MaxKids
...
sys2%bencap%doCap = sys%bencap%doCap
        sys2%bencap%doNI = sys%bencap%doNI
        ...
        sys2%bencap%LondonCapAmt = sys%bencap%LondonCapAmt
        sys2%bencap%LondonSinNoKids = sys%bencap%LondonSinNoKids * factor
        sys2%bencap%LondonSinKids = sys%bencap%LondonSinKids * factor
        sys2%bencap%LondonCouNoKids = sys%bencap%LondonCouNoKids * factor
        sys2%bencap%LondonCouKids = sys%bencap%LondonCouKids * factor
